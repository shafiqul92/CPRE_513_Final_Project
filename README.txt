...
at step 9, there is ~5% chance that you will trigger that has purposely been placed in the script. If this occurs,
...
3) You have Visual Studio Code (VSCode) isntalled.
...
If you don't have VSCode installed, follow this isntructions for your platform: https://code.visualstudio.com/docs/setup/setup-overview

If you don't have Python, venv, or pip installed, follow these instructions for your platform:
https://code.visualstudio.com/docs/python/python-tutorial

1) Open a new terminal in VSCode by going to Terminal in the top left, and clicking New Terminal
...
"Path requests for generator testing\Sample_test_cases_for_model_evaluattion_of_buggy_test_case.csv"
